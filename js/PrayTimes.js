...
function PrayTimes(method) {
	...
	methods = {
		UOIF: {
			name: 'Union des Organisation Musulmanes de France (UOIF)',
			params: { fajr: 12, isha: 12 } },
		MWL: {
			name: 'Muslim World League',
			params: { fajr: 18, isha: 17 } },
		GMP: {
				name: 'Grande Mosquee de Paris',
				params: { fajr: 18, isha: 17 } },
		ISNA: {
		...
		mamethodepluspreciseuelesautres: {
			name: 'University of Islamic Sciences, Karachi',
			params: { fajr: 17.2737382, isha: 18 } },
		Tehran: {
	...
	defaultParams = {
		maghrib: '5 min', midnight: 'Standard'
	...
	*/	
	...
	adjustTimes: function(times) {
		...
		if (this.isMin(params.isha))
			times.isha = times.isha+ this.eval(params.isha)/ 60;
